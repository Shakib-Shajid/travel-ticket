            ...
            <div className="max-w-7xl mx-auto" id="card">
                <div className="ml-4 md:ml-0 lg:my-20">
                    ...
                    <div className="flex flex-col md:flex-row gap-4 justify-center w-full">
                        <div className="card text-white bg-gradient-to-r from-[#00C48C] to-[#00A8E8] w-72">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-white">Precios más bajos exclusivos para clientes Smart.</h2>
                        ...
                        <div className="card text-white bg-gradient-to-r from-[#00C48C] to-[#00A8E8] w-72">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-white">Tarifa Smart para ti y tus acompañantes.</h2>
                        ...
                        <div className="card text-white bg-gradient-to-r from-[#00C48C] to-[#00A8E8] w-72">
                            <div className="card-body">
                                <h2 className="card-title text-xl font-extrabold text-white">Comparte los beneficios Smart.</h2>
