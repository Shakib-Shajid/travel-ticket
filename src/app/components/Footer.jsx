...
const Footer = () => {
    return (
        <div>
            <div className="bg-neutral font-open_sans hidden">
            ...
            <footer className="footer footer-center bg-gradient-to-r from-blue-500 via-teal-400 to-green-500 p-4">
                <aside>
                    <p>Copyright © {new Date().getFullYear()} - All right reserved by Smart Tour</p>
                </aside>
            </footer>
        </div>
    );
